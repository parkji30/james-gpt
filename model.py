...
class MultiHeadCausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        attention_scores = attention_scores.permute(0, 2, 1, 3).reshape(B, L, self.embedding_dim)
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, embed_dim:int, mlp_dim:int, num_heads:int):
        ...
        self.causal_attention = MultiHeadCausalSelfAttention(embed_dim, embed_dim, num_heads)
...
class GPT(nn.Module):
    ...
    def __init__(
        ...
        self.decoder_blocks = nn.ModuleList(
            [TransformerBlock(embed_dim=embed_dim, mlp_dim=mlp_dim, num_heads=num_heads) for _ in range(decoder_blocks)]
        )
